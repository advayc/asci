  ...
  return (
    <div className="min-h-screen w-full bg-black text-white">
      ...
      >
        ...
        {isHydrated && isDesktop && (
          <div
            className="order-3 w-2 bg-zinc-700/50 hover:bg-zinc-600/50 cursor-col-resize items-center justify-center z-10 transition-colors duration-200"
        ...
        <div
          className={`order-2 md:order-1 w-full md:h-auto p-3 md:p-6 bg-gradient-to-b from-zinc-900 to-zinc-950 font-mono text-zinc-300 transition-opacity duration-300 ${
        ...
        >
          <div className="space-y-5 p-4 md:p-5 border border-zinc-800 rounded-lg bg-zinc-900/50 backdrop-blur-sm shadow-xl">
            <div className="space-y-2">
              <h1 className="text-xl text-zinc-50 font-bold tracking-tight">ASCII Art Converter</h1>
            ...
            <div className="space-y-5 pt-1">
              <div className="space-y-3 border-t border-zinc-800 pt-5">
                <div className="flex items-center justify-between">
                  <Label htmlFor="resolution" className="text-zinc-200 font-medium">
                ...
                <Slider
                  ...
                  className="[&>span]:border-none"
                />
              </div>

              <div className="space-y-3 border-t border-zinc-800 pt-5">
                <Label htmlFor="charset" className="text-zinc-200 font-medium">
                  Character Set
                </Label>
                <Select value={charSet} onValueChange={setCharSet}>
                  <SelectTrigger id="charset" className="bg-zinc-800 border-zinc-700 text-zinc-100 hover:bg-zinc-750 transition-colors">
                    <SelectValue placeholder="Select character set" />
                  </SelectTrigger>
                  <SelectContent className="bg-zinc-800 border-zinc-700 text-zinc-100">
                    <SelectItem value="standard" className="focus:bg-zinc-700 focus:text-zinc-50">
                      Standard
                    </SelectItem>
                    <SelectItem value="detailed" className="focus:bg-zinc-700 focus:text-zinc-50">
                      Detailed
                    </SelectItem>
                    <SelectItem value="blocks" className="focus:bg-zinc-700 focus:text-zinc-50">
                      Block Characters
                    </SelectItem>
                    <SelectItem value="minimal" className="focus:bg-zinc-700 focus:text-zinc-50">
                      Minimal
                    </SelectItem>
                  </SelectContent>
                </Select>
              ...
              <div className="flex items-center justify-between space-x-3 border-t border-zinc-800 pt-5">
                <Label htmlFor="invert" className="text-zinc-200 font-medium cursor-pointer">
                  Invert Colors
                </Label>
                <Switch
                  id="invert"
              ...
              <div className="flex items-center justify-between space-x-3 border-t border-zinc-800 pt-5">
                <Label htmlFor="grayscale" className="text-zinc-200 font-medium cursor-pointer">
                  Grayscale Mode
                </Label>
                <Switch
                  id="grayscale"
              ...
              <div className="flex gap-2 pt-5 border-t border-zinc-800">
                <Button
                  onClick={() => {
                    if (!asciiArt) {
                  ...
                  className="flex-1 bg-zinc-700 hover:bg-zinc-600 text-zinc-100 border-zinc-600 transition-colors shadow-md"
                ...
                <Button
                  ...
                  className="bg-zinc-700 hover:bg-zinc-600 text-zinc-100 border-zinc-600 transition-colors shadow-md"
